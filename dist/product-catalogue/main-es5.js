...
var CatalogueComponent = /** @class */ (function () {
    function CatalogueComponent(category_service) {
...
var CategoryDetailComponent = /** @class */ (function () {
    function CategoryDetailComponent(category_service, route, router, product_service) {
        var _this = this;
        this.category_service = category_service;
        this.route = route;
        this.router = router;
        ...
        this.route.params.subscribe(function (params) {
            _this.category_service.getCategory(+params['id']).subscribe(function (category) {
                _this.category = category;
                console.log("Category: " + _this.category);
                console.log("Product Name: " + _this.category.categoryname);
                _this.category_service.setToStorage("category", _this.category);
            });
        });
    }
    CategoryDetailComponent.prototype.onDelete = function (category) {
        var _this = this;
        this.isDeleting = true;
        this.category_service.deleteCategory(category.categoryid).subscribe(function (data) {
            _this.categoryList = _this.categoryList.filter(function (c) { return c !== category; });
        }, function (error) {
        }, function () {
            setTimeout(function () {
    ...
    CategoryDetailComponent.prototype.onEdit = function () {
    ...
    CategoryDetailComponent.ctorParameters = function () { return [
        { type: _category_list_category_service__WEBPACK_IMPORTED_MODULE_2__["CategoryService"] },
...
var CategoryItemComponent = /** @class */ (function () {
    function CategoryItemComponent(router, category_service) {
        this.router = router;
        this.category_service = category_service;
    }
    CategoryItemComponent.prototype.onViewDetails = function (category) {
        this.router.navigate(['/categories', category.categoryid]);
    };
    CategoryItemComponent.prototype.ngOnInit = function () {
    };
    CategoryItemComponent.ctorParameters = function () { return [
...
var CategoryListComponent = /** @class */ (function () {
    function CategoryListComponent(category_service) {
        this.category_service = category_service;
    }
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getCategories = function () {
        ...
        this.http
            ...
            _this.setToStorage(_this.storageName, _this.categories);
        });
        return this.categories;
    };
    CategoryService.prototype.setToStorage = function (storageName, storageList) {
        localStorage.setItem(storageName, JSON.stringify(storageList));
    };
    CategoryService.prototype.getFromStorage = function (storageName) {
        var localStorageItem = JSON.parse(localStorage.getItem(storageName));
...
var CategoryStartupComponent = /** @class */ (function () {
    function CategoryStartupComponent() {
    }
    CategoryStartupComponent.prototype.ngOnInit = function () {
    };
    ...
    return CategoryStartupComponent;
}());
...
var EditCategoryComponent = /** @class */ (function () {
    function EditCategoryComponent(category_service, form_builder, route) {
        this.category_service = category_service;
    ...
    EditCategoryComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.editMode) {
            this.category_service.updateCategory(this.category.categoryid, this.addForm.value).subscribe(function (data) {
            }, function (error) {
                alert(error);
            }, function () {
                setTimeout(function () {
                    _this.category_service.displayMessage = true;
                    _this.uniqueMessageText = 'Updated';
                }, 1500);
            });
        }
        if (!this.editMode) {
            this.category_service.createNewCategory(this.addForm.value)
                ...
                console.log("Form's value: " + _this.addForm.value);
            }, function (error) {
            }, function () {
                setTimeout(function () {
                    _this.category_service.displayMessage = true;
                    _this.uniqueMessageText = 'Added';
                }, 1500);
            });
        }
    };
    EditCategoryComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            if (_this.editMode) {
                _this.category_service.getCategory(+params['id']).subscribe(function (category) {
                    _this.category = category;
                    _this.addForm = _this.form_builder.group({
                        categoryname: [_this.category.categoryname, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
                    });
                });
            }
        });
...
var EditProductComponent = /** @class */ (function () {
    function EditProductComponent(route, product_service, category_service, http) {
        this.route = route;
        this.product_service = product_service;
        this.category_service = category_service;
        this.http = http;
    ...
    EditProductComponent.prototype.handleFileInput = function (file) {
        var _this = this;
  ...
  */
    EditProductComponent.prototype.onSubmit = function (addForm) {
        var _this = this;
        if (this.editMode) {
            ...
            var last = this.product_service.getProducts()[this.product_service.getProducts().length - 1];
            var formData = new FormData();
            formData.append("file", this.fileToUpload);
            this.http
...
var ProductDetailComponent = /** @class */ (function () {
    function ProductDetailComponent(route, product_service, router) {
        this.route = route;
        this.product_service = product_service;
        this.router = router;
        this.product = {
    ...
    ProductDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.product_service.getProduct(+params['id']).subscribe(function (product) {
                _this.product = product;
...
var ProductItemComponent = /** @class */ (function () {
    function ProductItemComponent(product_service) {
        this.product_service = product_service;
    }
    ProductItemComponent.prototype.onEdit = function () {
        console.log("To edit");
    };
    ProductItemComponent.prototype.onDelete = function (product) {
        var _this = this;
        this.product_service.deleteProduct(product.productid).subscribe(function (data) {
            _this.productList = _this.productList.filter(function (p) { return p !== product; });
        });
    };
    ProductItemComponent.prototype.ngOnInit = function () {
    };
    ProductItemComponent.prototype.search = function () {
        var _this = this;
        if (this.productname != "") {
            this.productList = this.productList.filter(function (res) {
                return res.productname.toLocaleLowerCase().match(_this.productname.toLocaleLowerCase());
            });
        }
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(product_service) {
        this.product_service = product_service;
    }
...
var ProductService = /** @class */ (function () {
    function ProductService(category_service, http) {
        this.category_service = category_service;
        this.http = http;
    ...
    ProductService.prototype.getProducts = function () {
        ...
        this.http
            ...
            _this.category_service.setToStorage(_this.storageName, _this.products);
        });
    ...
    ProductService.prototype.createProduct = function (category_id, product) {
        return this.http.post(this.category_service.baseUrl + "products/category/" + category_id, product);
    };
    ProductService.prototype.updateProduct = function (category_id, product_id, product) {
    ...
    ProductService.prototype.uploadImage = function (productid, product) {
